<div
    class="anti-aircraft"
    role="img"
    aria-label="Une cible mobile suit une trajectoire. Un système mesure sa position, anticipe sa position future, vise cette position, puis compare l’anticipation à la position ensuite observée afin de recalibrer la prédiction suivante."
>
    <svg viewBox="0 0 1000 470" aria-hidden="true">
        <defs>
            <marker
                id="recalibration-arrow"
                markerWidth="8"
                markerHeight="8"
                refX="7"
                refY="4"
        ...
        <g class="measurement">
            ...
            <path
                class="sample-bracket"
                d="M363 118 L401 118 M382 99 L382 137"
            />
            ...
            <text class="scene-label measured-label" x="318" y="82"
                >POSITION MESURÉE</text
            >
        </g>
        ...
        <g class="prediction">
            ...
            <path
                class="prediction-cross"
                d="M610 56 L610 120 M578 88 L642 88"
            />
            <text class="scene-label prediction-label" x="554" y="44"
                >POSITION ANTICIPÉE</text
            >
        </g>
        ...
        <path class="trajectory" d="M232 383 C338 250 465 154 610 88" />
        ...
        <path
            class="recalibration"
            marker-end="url(#recalibration-arrow)"
            d="M644 102 C720 180 698 300 588 346 C470 395 326 356 246 385"
        />
        <text class="scene-label recalibration-label" x="547" y="365"
            >ÉCART DE PRÉDICTION</text
        >
        ...
        <text class="system-label" x="232" y="433" text-anchor="middle"
            >SYSTÈME</text
        >
    </svg>

    <div class="cycle" aria-hidden="true">
        <span class="observe">mesurer</span>
        <span class="arrow">→</span>
        <span class="predict">anticiper</span>
        <span class="arrow">→</span>
        <span class="act">viser</span>
        <span class="arrow">→</span>
        <span class="correct">recaler</span>
...
<style>
    ...
    .recalibration {
        ...
        stroke-width: 1.5;
        animation: recalibration-phase var(--cycle) ease-in-out infinite;
    }
    ...
    .recalibration-label {
        animation: recalibration-label-phase var(--cycle) linear infinite;
    }
    ...
    @keyframes recalibration-label-phase {
        0%,
        69%,
        89%,
        100% {
